...
class TestItemClass extends UnitTest {
  ...
  function test_SelectOverallBookUsage() {
    ...
    $copyrightData = intval($item->selectOverallBookUsage($query, $params, null));
  ...
  function test_selectOverallUsedPages() {
    $item = new reserveItem(133509);
    $query = 'SELECT i.item_id, i.pages_times_used, i.pages_times_total FROM items as i
            LEFT JOIN reserves as r on r.item_id = i.item_id
            WHERE r.course_instance_id = ? and i.ISBN = ?';  
    ...
    $isbn = '0140444734';
    $params = array($course_instance, $isbn);   
    $copyrightData = intval($item->selectOverallUsedPages($query, $params, null));
    $this->assertEqual('62', $copyrightData, "Should return correct copyright data = $copyrightData.");
    
    $isbn = '0300033060';
    $params = array($course_instance, $isbn);   
    $copyrightData = intval($item->selectOverallUsedPages($query, $params, null));
    $this->assertEqual('78', $copyrightData, "Should return correct copyright data = $copyrightData.");
    
    $isbn = '046500699';
    $params = array($course_instance, $isbn);   
    $copyrightData = intval($item->selectOverallUsedPages($query, $params, null));
    $this->assertEqual('67', $copyrightData, "Should return correct copyright data = $copyrightData.");
    
    $isbn = '047026649';
    $params = array($course_instance, $isbn);   
    $copyrightData = intval($item->selectOverallUsedPages($query, $params, null));
    $this->assertEqual('129', $copyrightData, "Should return correct copyright data = $copyrightData.");
    
    $isbn = '0788504886';
    $params = array($course_instance, $isbn);   
    $copyrightData = intval($item->selectOverallUsedPages($query, $params, null));
    $this->assertEqual('42', $copyrightData, "Should return correct copyright data = $copyrightData.");    
  }
}
