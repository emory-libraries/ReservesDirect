<?php
	...
	$rss_str = "feed2js.php?src=" . urlencode($feed) . "&chan=y&num=3&desc=200&date=y";	
...
<p>You may also use the form below to <strong>modify</strong> the CSS to experiment with your own variants. If you make something unique, pretty, or just plain interesting, please <strong>share it</strong> so we can build a nicer collection.</p>
