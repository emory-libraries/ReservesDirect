...
require_once("secure/displayers/selectClassDisplayer.class.php");

class selectClassManager
{
	public $user;
	public $displayClass;
	...
	function selectClassManager($cmd, $nextCmd, $tab, $performAction, $user, $request, $hidden_fields=null)
	{
		global $g_permission, $page, $loc, $ci;

		$this->displayClass = "selectClassDisplayer";
		...
		switch ($cmd)
		{
			case 'lookupClass':
				...
				$this->argList = array($nextCmd, $performAction, $instr_list, $course_list, $ci_list, $_REQUEST, $hidden_fields);
		}
	}
}
