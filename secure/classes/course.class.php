...
class course
{
  ...
  public $ca_ciid;   // added to validate addCrosslisting test.  
  ...
  */
  private function getCourse($courseAliasID)
  {
    ...
    {
      default: //'mysql'
        $sql = "SELECT ca.course_id, c.department_id, c.course_number, ca.course_name, c.uniform_title, ca.section, ca.course_alias_id, ca.registrar_key, ca.override_feed, ca.course_instance_id "
  ...
  */
  ...
  function getCA_CIID() { return $this->ca_ciid; }    
